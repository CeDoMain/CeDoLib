...
private:
    ...
    unsigned long FadeTime;            // Zeit in ms, die für den Fade benötigt wird
...
public:
    ...
    void Start(unsigned long fadeTime, decimal to);

    // Startet den Fade im angegebenen Intervall
    void Start(unsigned long fadeTime, decimal from, decimal to);
